...
public class BillingService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = billingObj.insertBilling(
				request.getParameter("bAccountNo"),      
				request.getParameter("bUnits"),
				request.getParameter("bUnitPrice"),
				request.getParameter("bAmount"),
				request.getParameter("bRemark")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = billingObj.updateBilling(
		    		...
		    		paras.get("bAccountNo").toString(),     
		    		paras.get("bUnits").toString(),
		    		paras.get("bUnitPrice").toString(),
		    		paras.get("bAmount").toString(),
		    		paras.get("bRemark").toString()); 		 
		 			response.getWriter().write(output);
	}
